...
> 每天一题，督促自己
> 从多方面多角度总结答案，丰富知识
> [请求时浏览器缓存 from memory cache 和 from disk cache 的依据是什么，哪些数据什么时候存放在 Memory Cache 和 Disk Cache 中？](https://github.com/Advanced-Frontend/Daily-Interview-Question/issues/53)
> 简书整合地址：[前端 100 问](https://www.jianshu.com/c/70e2e00df1b0)

#### 正文回答

深度好文：[深入理解浏览器的缓存机制](https://www.jianshu.com/p/54cc04190252)
...
Push Cache 在国内能够查到的资料很少，也是因为 HTTP/2 在国内不够普及。但是有一些结论可以看看：
